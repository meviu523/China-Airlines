...
export const enUSMessages = {
  ...
  'settings.saveCompatibilityHelp': 'Offline progress is capped at 8 hours. Imports do not advance file time. Versions 1–6 are no longer supported; active-model v7–v8 saves are strictly validated and migrated to v9, while v9 restores directly. Retired or unknown aircraft reject the import without overwriting current progress.',
